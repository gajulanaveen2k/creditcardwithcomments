...
/**
* <h1>Address Model</h1>
* The Address Model program is an embeddable one such that
* the Customer model can embedded this one to complete the details and send the details to entity with help of Parser
